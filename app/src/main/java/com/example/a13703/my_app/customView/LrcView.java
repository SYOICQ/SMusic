...
import com.example.a13703.my_app.Inter_kou.ILrcView;
...
public class LrcView extends View implements ILrcView {
    ...
    //最小的移动距离
    private int mMinSeekOffset = 10;
    //当前高亮歌词的行数
    private int mHighLightRow = 0;
    //当前高亮歌词的颜色
    private int mHighLightRowColor = getResources().getColor(R.color.high_light);
    //普通字体颜色
    private int mNormalRowColor = Color.WHITE;
    //拖动歌词时，当前高亮歌词下面一条直线的字体颜色
    private int mSeekLineColor = Color.CYAN;
    //拖动歌词时，展示当前高亮歌词的字体颜色
    private int mSeekLineTextColor = Color.CYAN;
    //拖动歌词时，展示当前高亮歌词的时间的字体大小
    private int mSeekLineTextSize = 22;
    ...
    //没有歌词显示的内容
    private String mLoadingLrcTip = "小S提示：暂无歌词哦！";
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mDisplayMode == DISPLAY_MODE_SEEK) {
            ...
            canvas.drawText(mLrcRows.get(mHighLightRow).startTime, 0, highlightRowY, mPaint);
        }
