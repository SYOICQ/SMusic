...
import com.example.a13703.my_app.Listening;
...
public class SongAdapter extends ArrayAdapter<Local_music>  implements View.OnClickListener {
    private int resourceId;
    private InnerItemOnclickListener mListener;
    public SongAdapter(Context context,int textViewResourceId,List<Local_music> objects) {
